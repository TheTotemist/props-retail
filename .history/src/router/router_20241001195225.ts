...
const routes = [
  ...
  {path: '/woodtotems/1', name: 'Woodtotems', component: woodtotems/1},
  {path: '/woodtotems/2', name: 'Woodtotems', component: woodtotems/2},
  {path: '/woodtotems/3', name: 'Woodtotems', component: woodtotems/3},
]
